...
fun CustomTopAppBar(
    ...
    if (currentRoute == null ||
        ...
        currentRoute == Destinations.chat.route ||
        currentRoute == Destinations.Pantalla4.route
        )
    {
        return
    }
...
@Composable
fun MoreAction(themeType: MutableState<ThemeType>, darkMode: MutableState<Boolean>) {
