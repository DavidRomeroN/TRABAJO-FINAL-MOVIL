...
@Composable
fun InfoAlimentacion(servicio: ServicioAlimentacionResp?) {
    ...
    Card(
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text(
                    text = "Tipo de comida: ${servicio?.tipoComida}",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
                Text(
                    text = "Estilo gastronómico: ${servicio?.estiloGastronomico}",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
                Text(
                    text = if(servicio?.incluyeBebidas=="SI") "Incluye bebidas" else "No incluye bebidas",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
            }
