    ...
    Scaffold(modifier = Modifier.padding(top = 80.dp, start = 16.dp, end = 16.dp, bottom =
        ...
        BuildEasyForms { easyForm ->
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                NameTextField(easyForms = easyForm, text=servicioAlimentacion?.tipoComida!!,"Tipo de Comida:", MyFormKeys.NAME )
                ...
                Row(Modifier.align(Alignment.CenterHorizontally)){
                    AccionButtonSuccess(easyForms = easyForm, "Guardar", id){
                        ...
                        navController.navigate(Destinations.ServicioAlimentacionMainSC.route){
                            popUpTo(Destinations.ServicioAlimentacionFormSC.route) { inclusive = true }
                        }
                    }
                    Spacer()
