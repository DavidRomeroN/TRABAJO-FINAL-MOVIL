...
@Composable
fun InfoArtesania(servicio: ServicioArtesaniaResp?) {
    ...
    Card(
        ...
        Column(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text(
                    text = "Tipo de artesanía: ${servicio?.tipoArtesania}",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
                Text(
                    text = "Dificultad: ${servicio?.nivelDificultad}",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
                Text(
                    text = "Artesanía: ${servicio?.artesania}",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
                Text(
                    text = "Artesano: ${servicio?.artesano}",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
                Text(
                    text = "Origen Cultural: ${servicio?.origenCultural}",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
                Text(
                    text = "N° máximo de participantes: ${servicio?.maxParticipantes}",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
                Text(
                    text = if(servicio?.incluyeMaterial==true) "Incluye material" else "No incluye material",
                    style = MaterialTheme.typography.bodyMedium,
                    color = Color.Gray
                )
            }
